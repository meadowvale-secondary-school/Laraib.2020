...
let washingFace = 2
let checkingPhone = 5
let changingClothes = 6
let eatingBreakfast = 4
let makingBag = 3
...
let totalTime = brushTeeth + washingFace + checkingPhone + changingClothes + eatingBreakfast + makingBag
// Very accurate time for me to get ready, in first try
...
let haveToDo = brushTeeth + washingFace + changingClothes + makingBag
let likeToDo = checkingPhone
let dontLikeToDo = eatingBreakfast
...
*/
// things i want to be able to do in the morning
let makingSmoothie = 7
totalTime + makingSmoothie
// cut down breakfast time from 10 minutes to 5 and added smoothie time to total time
