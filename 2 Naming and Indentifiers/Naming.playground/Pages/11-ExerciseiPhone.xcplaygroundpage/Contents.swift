...
let takenUpStorage = 3000
let oneMinuteVideo = 150

// calculations
let avalibleStorage = totalStorage - takenUpStorage
let totalMinutes = avalibleStorage / oneMinuteVideo
// therefore, you will need 33 minutes of video to fill up the iphone
