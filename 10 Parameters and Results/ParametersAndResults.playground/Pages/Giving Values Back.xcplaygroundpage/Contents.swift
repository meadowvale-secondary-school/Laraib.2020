 ...
 */
func myFavoriteThing(categoryOfThing: String, favorite: String) -> String {
    return "My favorite \(categoryOfThing) is \(favorite)"
}
var favorite = myFavoriteThing(categoryOfThing:"Snack", favorite: "Chips")
print(favorite)
...
favorite = myFavoriteThing(categoryOfThing:"Food", favorite: "Lasagna")
print(favorite)

print("Hello, my name is laraib. \(favorite).")
