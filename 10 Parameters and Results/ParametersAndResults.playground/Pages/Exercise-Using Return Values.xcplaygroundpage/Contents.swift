...
let count = impossibleBeliefsCount(pigsFlying: 5, frogsBecomingPrinces: 6, multipleLightningStrikes: 4)
//print(count)
...
var impossible = impossibleThingsPhrase(numberOfImpossibleThings: 10, meal:"Pizza")
print(impossible)

impossible = impossibleThingsPhrase(numberOfImpossibleThings: count, meal: "Shawarma")
print(impossible)
