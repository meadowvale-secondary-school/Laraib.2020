...
let basketBallPlayer = "Lebron James"
let pointInFirstQt = 25
let secondInFirstQt = 30
let team = "Toronto Raptors"
let team2 = "Los Angeles Lakers"

let finalStory = "Today was a big day for \(basketBallPlayer). He in the first quarter scored \(pointInFirstQt) against \(team). He scored \(secondInFirstQt) in the second quarter for his team the \(team2)"
